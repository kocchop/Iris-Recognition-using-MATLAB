...
% figure,imshow(I2),figure,imshow(or);
% imwrite(I2,'canny_I2.jpg'),imwrite(or,'canny_or.jpg'),
I3 = adjgamma(I2, 1.9);
% figure,imshow(I3);
...
% imwrite(I3,'adjgamma.jpg'),imwrite(I4,'nonmaxsup.jpg'),imwrite(edgeimage,'hysthresh.jpg');
